...
ba:
	docker build -t ryutaterada/k8s-express:1.2.0 ./src/api
	docker push ryutaterada/k8s-express:1.2.0

bw:
	docker build -t ryutaterada/k8s-nodejs:1.1.6 ./src/web
	docker push ryutaterada/k8s-nodejs:1.1.6
