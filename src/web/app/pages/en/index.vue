<template>
  <v-layout>
    <v-flex xs12 sm12 md12>
      <div id="top">
            <img src="/topimg.png" alt="メインビジュアル" style="width: 100%;height: 600px;object-fit: cover;opacity: 0.6;">
            <input type="text" id="keyword_input" placeholder="keywords">
            <img src="/madejp.png" alt="madeinjapan" id="madejp">
            <div id="loop_body">
              <client-only>
                <div id="loopslider">
                  <ul>
      ...
      <div id="top_body">
        <div id="pickup_ws">
          <div class="contents_title">Tenshoku Pickup!</div>
          <div id="ws_info">
            <img src="/topimg.png" alt="workshop_img" style="width: 550px;height: 350px;object-fit: cover;" />
            <div id="ws_detail">
              <div id="ws_title">Tenshoku workshop</div>
              <div id="ws_description">
                This workshop is keep up the Edo traditions.We craft chopstick,accessories,armor and etc... make simple and careful a goal.
              </div>
              <div id="ws_rate">
                <v-rating
        ...
        <div id="new_pro">
          <div class="contents_title">New products</div>
          <div id="new_products">
        ...
        <div id="new_pro">
          <div class="contents_title">Hot products</div>
          <div id="new_products">
        ...
        <div id="finding">
          <div class="contents_title">Look for...</div>
          <div id="genres">
            <div class="genre"></div>
            <div class="genre"></div>
            <div class="genre"></div>
