  ...
  <v-layout row wrap style="">
    ...
    <dir id="random_body">
      <div id="shopper" @click="$router.push(`/customer/workshop/${mall[0][0].shop_id}`)">
        ...
        <img src="/man2.gif" alt="行商人" style="width: 100%;object-fit: cover;">
      </div>
      <div id="shopper2" @click="$router.push(`/customer/workshop/${mall[0][0].shop_id}`)">
        ...
        <img src="/man1.gif" alt="行商人" style="width: 100%;object-fit: cover;">
      </div>
      <div id="shopper3" @click="$router.push(`/customer/workshop/${mall[0][0].shop_id}`)">
        ...
        <img src="/man4.gif" alt="行商人" style="width: 100%;object-fit: cover;">
      </div>
      <div id="shopper4" @click="$router.push(`/customer/workshop/${mall[0][0].shop_id}`)">
        ...
        <img src="/man3.gif" alt="行商人" style="width: 100%;object-fit: cover;">
      </div>
    </dir>


    <h5 style="width: 100%;text-align: center;" @click="move_shopper">ランダムモール</h5>
