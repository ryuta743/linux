...
export const actions = {
    async select_product({
        ...
        var productname = await this.$axios.$get(`http://express-service.default.svc.cluster.local/product/get_product?pro_data=${payload.product}`);
    ...
    async getproductdetails({
        ...
        const product_details = await this.$axios.$get(`http://express-service.default.svc.cluster.local/product/get_details?id_data=${p_data.product_id}`);
    ...
    async get_newproduct({
        ...
        const new_productdata = await this.$axios.$get(`http://express-service.default.svc.cluster.local/product/get_newdata`);
