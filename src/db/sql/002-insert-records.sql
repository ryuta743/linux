...
(NULL,1,"天職茶碗","tenshokuchawan",1,1200,"2019/12/28","ヒノキの香りがする伝統ある茶碗です。","https://firebasestorage.googleapis.com/v0/b/hackmdbase-57369.appspot.com/o/images.jpeg?alt=media&token=6b99e5bf-ee7c-4919-ade5-91c8710d49cb",30,10,"40*40*150(cm)","青銅、鉄","800g");

INSERT INTO `product_lists` VALUES
(NULL,1,"天職コップ","tenshokukoppu",2,1500,"2019/12/28","ヒノキの香りがする伝統ある茶碗です。","https://firebasestorage.googleapis.com/v0/b/hackmdbase-57369.appspot.com/o/images.jpeg?alt=media&token=6b99e5bf-ee7c-4919-ade5-91c8710d49cb",30,10,"40*40*150(cm)","青銅、鉄","800g");
...
INSERT INTO `product_lists` VALUES
(NULL,4545,'神の壺',"kaminotubo",15,400000,'2020/01/27','安いよ','http://i.gzn.jp/img/2018/01/15/google-gorilla-ban/00.jpg',8,5,"40*40*150(cm)","青銅、鉄","800g");